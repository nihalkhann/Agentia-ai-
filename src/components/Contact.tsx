  ...
  return (
    <section id="contact" className="bg-black text-white py-16">
      <div className="container mx-auto px-6 sm:px-6 lg:px-40">
        <h2 className="text-black md:text-transparent text-3xl md:text-4xl font-bold mb-4 text-center bg-gradient-to-r from-purple-400 to-blue-500  bg-clip-text rounded-xl">
          Get in Touch
        </h2>
